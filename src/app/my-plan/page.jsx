                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="mt-10 flex gap-3 border-b border-white/10 pb-4">
                        <button
                            ...
                            className={`rounded-full px-5 py-2.5 text-sm font-bold transition ${activeTab === "plan"
                        ...
                        <button
                            ...
                            className={`rounded-full px-5 py-2.5 text-sm font-bold transition ${activeTab === "saved"
                                    ? "bg-[#ccff00] text-black"
                                    : "border border-white/10 bg-white/[0.03] text-white/50 hover:text-white"
                                }`}
                        >
                        ...
                        <div className="mt-8 grid gap-5">
                            {currentItems.map((workout) => {
                                ...
                                return (
                                    <div
                                        key={workout.id}
                                        className={`group overflow-hidden rounded-2xl border bg-white/[0.03] transition ${isDone
                                        ...
                                        <div className="flex flex-col sm:flex-row">
                                            ...
                                            <div className="flex flex-1 flex-col justify-between p-5 sm:p-6">
                                                <div>
                                                    ...
                                                    <h2
                                                        className={`mt-4 text-2xl font-black ${isDone
                                                ...
                                                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                                                    ...
                                                    {activeTab === "plan" && (
                                                        <button
                                                            ...
                                                            className={`flex-1 rounded-full px-5 py-3 text-xs font-black tracking-wide transition ${isDone
